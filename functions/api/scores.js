...
const ALLOWED_GAMES = new Set(['space-dogfight', 'space-dogfight-easy', 'space-dogfight-medium', 'space-dogfight-hard', '4ordle', 'tic-tac-toe', 'save-my-chicks', 'gnome-crawler', 'aim-trainer', 'night-fishing']);
